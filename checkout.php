<?php
	...
	if(isset($_POST['commander']) && !empty($_POST['commander']))
	{
		...
		if($stat->execute($data))
		{
			...
			$sql3= "UPDATE produits SET quantite=(quantite-".$produit['quantite'].") where id=".$produit['idProduit']."";
...
<html lang="en">
<head>
	<title>Check-out | LuxForAll</title>
						...
						<div class="col-md-6">
							<div class="cart-detail bg-light p-3 p-md-4">
								...
								<div class="form-group">
									<div class="col-md-12">
										<div class="checkbox">
											<label><input class="mr-2" type="checkbox" value="" required>J'ai lu et j'accepte les termes et <a href="condition.php" target="_blank"><u>conditions luxForAll</u></a></label>
										</div>
									</div>
								</div>
