...
if(sizeof($produit)>0){
   ...
   /* Modifier produit */
        ...
        $description= htmlspecialchars($_POST["description"]);
            ModifierProduit($idp,$libelle,$prix,$quantite,$categorie,$type,$description, $db);
    ...
    <section class="ftco-section contact-section bg-light">
		<div class="container">
			...
			<option value="<?=$categorie[0];?>">
                        ...
                        <div class="form-group">
                        <label>type </label> <input class="form-control"  name="type" value="<?= $type;?>"><p class="type">	neuf or utilisé	</p>				</div>
                        <div class="form-group">
