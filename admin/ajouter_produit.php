<?php
  ...
  //récupérer tous les categories des produits depuis la base de données
   ...
   /* Ajouter produit */
        ...
        AjouterProduit($libelle,$prix,$quantite,$image,$categorie,$type,$description, $db);
    ...
    <section class="ftco-section contact-section bg-light">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 order-md-last d-flex">
					<form action="" method="POST" class="bg-white p-5 contact-form">
                        ...
                        <input list="categorie" class="form-control" placeholder="Categorie" name="categorie" />
			...
			<option value="<?=$categorie[0];?>">
                        ...
                        <div class="form-group">
                        <label>type</label>
                        <input list="type" placeholder="Type" class="form-control" name="type" required>
                        <datalist id="type">
                        <option value="neuf">
                        <option value="utilisé">
                        </datalist>
                        <p class="type">	neuf or utilisé	</p>
                        <div class="form-group">
